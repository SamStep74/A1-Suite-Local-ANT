# Worker Task: fleet-management
- Session: `a1-sub-plans-7-10`
- Repo root: `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT`
- Worktree: `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT-a1-sub-plans-7-10-fleet-management`
- Branch: `a1/sub-plan-fleet-management`
- Launcher status file: `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/status.md`
- Launcher handoff file: `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/handoff.md`
- Tag to ship: `fleet-management-mvp`
## Seeded Local Overlays
- `HANDOFF.md`
- `package.json`
## Plan File
Path: `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT/docs/superpowers/plans/2026-06-08-a1-suite-ant-fleet-management.md`
### Plan File Contents
<plan>
...
## Objective
You are implementing sub-plan 9 (Fleet Management) of the A1 Suite / Armosphère One project — vehicle register, fuel logs, maintenance schedules, and trip sheets.

## Your worktree
You are running in: {worktree_path}
The branch is: a1/sub-plan/fleet-management (already created from ant/main)

## The plan
READ THIS FILE IN FULL FIRST, end to end, before doing anything else:
  /Users/samvelstepanyan/dev/A1-Suite-Local-ANT/docs/superpowers/plans/2026-06-08-a1-suite-ant-fleet-management.md
...
For every module you add, ship exactly these four artifacts:
  1. Pure deterministic engine at  server/fleet.js   (no I/O, no Fastify, testable in isolation)
  2. Thin route block in          server/app.js      (auth → requireAppAccess → audit → handler)
  3. React panel at               web/src/fleet.jsx  (inline Armenian strings, no i18n)
  4. node --test contract suite   test/fleet.test.js (math + auth-gating + idempotency)

The fleet module may share the inventory app for fuel/parts stock; confirm the relationship in the plan before deciding whether to add a new app entry (it should NOT — the apps list stays at 13).
...
3. Write a one-paragraph handoff to:  /Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/handoff.md
4. Update status:  /Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/status.md
5. Push branch and tag:  `git push ant a1/sub-plan/fleet-management`  then  `git push ant fleet-management-mvp`
...
The worker launcher captures your response in `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/handoff.md` automatically.
The worker launcher updates `/Users/samvelstepanyan/dev/A1-Suite-Local-ANT/.orchestration/a1-sub-plans-7-10/fleet-management/status.md` automatically.
## Tag to Ship
When done, push tag `fleet-management-mvp` to remote `ant`:
```bash
git push ant fleet-management-mvp
```
