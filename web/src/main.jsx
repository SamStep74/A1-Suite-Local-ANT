...
function App() {
  ...
  return (
    <Workspace
      ...
      pilotTemplateData={pilotTemplateData}
      pilotOwnerBriefs={pilotOwnerBriefs}
      pilotOperatorWorkbenches={pilotOperatorWorkbenches}
      pilotAccountantReviews={pilotAccountantReviews}
      pilotLaunchReadinessPackets={pilotLaunchReadinessPackets}
      pilotLaunchRemediationPlans={pilotLaunchRemediationPlans}
      pilotRemediationResolutions={pilotRemediationResolutions}
      pilotLaunchClearancePackets={pilotLaunchClearancePackets}
      pilotPaidOffers={pilotPaidOffers}
      pilotQuoteHandoffs={pilotQuoteHandoffs}
      pilotQuoteReleases={pilotQuoteReleases}
      pilotQuoteAcceptanceHandoffs={pilotQuoteAcceptanceHandoffs}
      pilotHayhashvapahDrafts={pilotHayhashvapahDrafts}
      pilotOfficialInvoices={pilotOfficialInvoices}
      pilotPaymentCollections={pilotPaymentCollections}
      pilotCloseouts={pilotCloseouts}
      pilotRenewalQuoteHandoffs={pilotRenewalQuoteHandoffs}
      pilotRenewalQuoteReleases={pilotRenewalQuoteReleases}
      pilotRenewalAcceptanceHandoffs={pilotRenewalAcceptanceHandoffs}
      pilotRenewalHayhashvapahDrafts={pilotRenewalHayhashvapahDrafts}
      pilotRenewalOfficialInvoices={pilotRenewalOfficialInvoices}
      pilotRenewalPaymentCollections={pilotRenewalPaymentCollections}
      pilotRenewalCloseouts={pilotRenewalCloseouts}
      pilotNextRenewalQuoteHandoffs={pilotNextRenewalQuoteHandoffs}
      pilotNextRenewalQuoteReleases={pilotNextRenewalQuoteReleases}
      pilotNextRenewalAcceptanceHandoffs={pilotNextRenewalAcceptanceHandoffs}
      pilotNextRenewalHayhashvapahDrafts={pilotNextRenewalHayhashvapahDrafts}
      pilotNextRenewalOfficialInvoices={pilotNextRenewalOfficialInvoices}
      pilotNextRenewalPaymentCollections={pilotNextRenewalPaymentCollections}
      pilotNextRenewalCloseouts={pilotNextRenewalCloseouts}
      pilotFollowingRenewalQuoteHandoffs={pilotFollowingRenewalQuoteHandoffs}
      pilotFollowingRenewalQuoteReleases={pilotFollowingRenewalQuoteReleases}
      pilotFollowingRenewalAcceptanceHandoffs={pilotFollowingRenewalAcceptanceHandoffs}
      pilotFollowingRenewalHayhashvapahDrafts={pilotFollowingRenewalHayhashvapahDrafts}
      pilotFollowingRenewalOfficialInvoices={pilotFollowingRenewalOfficialInvoices}
      pilotFollowingRenewalPaymentCollections={pilotFollowingRenewalPaymentCollections}
      pilotFollowingRenewalCloseouts={pilotFollowingRenewalCloseouts}
      pilotSubsequentRenewalQuoteHandoffs={pilotSubsequentRenewalQuoteHandoffs}
      pilotSubsequentRenewalQuoteReleases={pilotSubsequentRenewalQuoteReleases}
      pilotSubsequentRenewalAcceptanceHandoffs={pilotSubsequentRenewalAcceptanceHandoffs}
      pilotSubsequentRenewalHayhashvapahDrafts={pilotSubsequentRenewalHayhashvapahDrafts}
      pilotSubsequentRenewalOfficialInvoices={pilotSubsequentRenewalOfficialInvoices}
      pilotSubsequentRenewalPaymentCollections={pilotSubsequentRenewalPaymentCollections}
      pilotSubsequentRenewalCloseouts={pilotSubsequentRenewalCloseouts}
      pilotContinuationRenewalQuoteHandoffs={pilotContinuationRenewalQuoteHandoffs}
      pilotContinuationRenewalQuoteReleases={pilotContinuationRenewalQuoteReleases}
      pilotContinuationRenewalAcceptanceHandoffs={pilotContinuationRenewalAcceptanceHandoffs}
      pilotContinuationRenewalHayhashvapahDrafts={pilotContinuationRenewalHayhashvapahDrafts}
      pilotContinuationRenewalOfficialInvoices={pilotContinuationRenewalOfficialInvoices}
      pilotContinuationRenewalPaymentCollections={pilotContinuationRenewalPaymentCollections}
      pilotContinuationRenewalCloseouts={pilotContinuationRenewalCloseouts}
      pilotOngoingRenewalQuoteHandoffs={pilotOngoingRenewalQuoteHandoffs}
      pilotOngoingRenewalQuoteReleases={pilotOngoingRenewalQuoteReleases}
      pilotOngoingRenewalAcceptanceHandoffs={pilotOngoingRenewalAcceptanceHandoffs}
      pilotOngoingRenewalHayhashvapahDrafts={pilotOngoingRenewalHayhashvapahDrafts}
      pilotOngoingRenewalOfficialInvoices={pilotOngoingRenewalOfficialInvoices}
      pilotOngoingRenewalPaymentCollections={pilotOngoingRenewalPaymentCollections}
      pilotOngoingRenewalCloseouts={pilotOngoingRenewalCloseouts}
      pilotNextOngoingRenewalQuoteHandoffs={pilotNextOngoingRenewalQuoteHandoffs}
      pilotNextOngoingRenewalQuoteReleases={pilotNextOngoingRenewalQuoteReleases}
      pilotNextOngoingRenewalAcceptanceHandoffs={pilotNextOngoingRenewalAcceptanceHandoffs}
      pilotNextOngoingRenewalHayhashvapahDrafts={pilotNextOngoingRenewalHayhashvapahDrafts}
      pilotNextOngoingRenewalOfficialInvoices={pilotNextOngoingRenewalOfficialInvoices}
      pilotNextOngoingRenewalPaymentCollections={pilotNextOngoingRenewalPaymentCollections}
      pilotNextOngoingRenewalCloseouts={pilotNextOngoingRenewalCloseouts}
      pilotFollowingOngoingRenewalQuoteHandoffs={pilotFollowingOngoingRenewalQuoteHandoffs}
      pilotFollowingOngoingRenewalQuoteReleases={pilotFollowingOngoingRenewalQuoteReleases}
      pilotFollowingOngoingRenewalAcceptanceHandoffs={pilotFollowingOngoingRenewalAcceptanceHandoffs}
      pilotFollowingOngoingRenewalHayhashvapahDrafts={pilotFollowingOngoingRenewalHayhashvapahDrafts}
      pilotFollowingOngoingRenewalOfficialInvoices={pilotFollowingOngoingRenewalOfficialInvoices}
      pilotFollowingOngoingRenewalPaymentCollections={pilotFollowingOngoingRenewalPaymentCollections}
      pilotFollowingOngoingRenewalCloseouts={pilotFollowingOngoingRenewalCloseouts}
      pilotSubsequentOngoingRenewalQuoteHandoffs={pilotSubsequentOngoingRenewalQuoteHandoffs}
      pilotSubsequentOngoingRenewalQuoteReleases={pilotSubsequentOngoingRenewalQuoteReleases}
      pilotSubsequentOngoingRenewalAcceptanceHandoffs={pilotSubsequentOngoingRenewalAcceptanceHandoffs}
      pilotSubsequentOngoingRenewalHayhashvapahDrafts={pilotSubsequentOngoingRenewalHayhashvapahDrafts}
      pilotSubsequentOngoingRenewalOfficialInvoices={pilotSubsequentOngoingRenewalOfficialInvoices}
      pilotSubsequentOngoingRenewalPaymentCollections={pilotSubsequentOngoingRenewalPaymentCollections}
      pilotSubsequentOngoingRenewalCloseouts={pilotSubsequentOngoingRenewalCloseouts}
      pilotNextRecurringOngoingRenewalQuoteHandoffs={pilotNextRecurringOngoingRenewalQuoteHandoffs}
      pilotNextRecurringOngoingRenewalQuoteReleases={pilotNextRecurringOngoingRenewalQuoteReleases}
      pilotNextRecurringOngoingRenewalAcceptanceHandoffs={pilotNextRecurringOngoingRenewalAcceptanceHandoffs}
      pilotNextRecurringOngoingRenewalHayhashvapahDrafts={pilotNextRecurringOngoingRenewalHayhashvapahDrafts}
      pilotNextRecurringOngoingRenewalOfficialInvoices={pilotNextRecurringOngoingRenewalOfficialInvoices}
      pilotNextRecurringOngoingRenewalPaymentCollections={pilotNextRecurringOngoingRenewalPaymentCollections}
      pilotNextRecurringOngoingRenewalCloseouts={pilotNextRecurringOngoingRenewalCloseouts}
