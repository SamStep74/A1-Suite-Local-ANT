...
_Last updated: 2026-06-02 · main after connector scope guard · 41 tags · **366 tests (366 pass, 0 fail, 0 cancelled)**_
...
### Hardening (production-readiness pass — 41 slices)
...
Current checkpoint:
- Latest connector scope guard checkpoint: this checkpoint (`Reject malformed connector scopes`), pushed with this handoff.
