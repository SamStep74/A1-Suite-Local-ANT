...
- Choice fields remain limited to their existing enums, text fields reject object/array/control-character/overlong input, satisfaction scores must be bounded 1-5 values, and duplicate escalation/resolution calls keep their existing idempotent behavior.
