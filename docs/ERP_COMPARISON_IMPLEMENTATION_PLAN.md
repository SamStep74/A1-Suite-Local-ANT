...
- A1 now has a first POS cash-session, sale-posting, fiscal-handoff, accounting, payment-split, terminal-settlement, processor-fee, and refund-evidence spine: POS app entry, role-gated workspace, tenant-scoped cash sessions, register opening, Z-report-like closeout evidence, receipt range fields, durable sale/line/payment rows, cash expected-cash updates, source-key replay, stock delivery moves for stock-tracked fiscal items, checksum-backed local receipt handoff packets, split-aware sale revenue-VAT-settlement ledger journals, refund revenue-VAT-settlement ledger journals, closed-session card terminal settlement and processor-fee evidence, full-sale refund evidence with tracked-line stock return moves, first single partial refund amount evidence, audit events, and backup coverage.
- A1 still does not have full retail operations: offline replay, voids, line-level partial stock-return workflows, receipt printing/live fiscal-device submission, lots/serials, live payment-terminal provider feeds, chargeback reconciliation, loyalty, or deep barcode operations.
...
| POS | Browser POS, offline mode, cash sessions, stock sync, receipts | First cash-session/fiscal closeout spine, cash sale posting, tracked-item stock decrement, checksum-backed fiscal receipt handoff packets, full-sale refund evidence with tracked-line stock return moves, first single partial refund amount evidence, split payment evidence, split-aware sale revenue/VAT settlement journals, closed-session card terminal settlement evidence, and processor-fee reconciliation evidence shipped; offline replay, voids, line-level partial stock returns, receipt printing/live fiscal-device submission, lots/serials/barcode depth, live terminal feeds, and chargeback reconciliation still missing | P1 |
...
- Modern POS sale capture panel for one-line fiscal catalog sales with optional split-payment entry and visible payment and sale ledger journal evidence while keeping fiscal-device submission, voids, line-level partial stock returns, and offline replay deferred.
...
- Browser POS:
  ...
  - customer selection, discounts, returns/refunds. First full-sale refund evidence, tracked-line return stock moves, and single partial refund amount evidence shipped; customer-linked refunds, voids, and line-level partial stock returns remain.
  - barcode input.
...
- Finance integration:
  ...
  - returns -> credit/refund journal. First balanced full-sale and single partial refund reversal journals shipped; customer-linked refunds and line-level partial stock returns remain.
- Tests:
...
5. POS with Armenian fiscal evidence; first cash-session closeout, cash sale posting, payment split evidence/accounting, stock decrement, local receipt handoff packets, full-sale refund evidence, single partial refund amount evidence, sale/refund ledger journals, closed-session card terminal settlement evidence, and processor-fee reconciliation evidence shipped, next focus is offline/live-fiscal-device handling, richer returns, line-level partial stock returns, live terminal feeds, and chargeback reconciliation.
