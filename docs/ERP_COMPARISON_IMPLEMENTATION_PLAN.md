...
- A1 still does not have full retail operations: offline replay, voids/partial refunds, receipt printing/live fiscal-device submission, payment split accounting, lots/serials, live payment-terminal provider feeds, chargeback reconciliation, loyalty, or deep barcode operations.
...
| POS | Browser POS, offline mode, cash sessions, stock sync, receipts | First cash-session/fiscal closeout spine, cash sale posting, tracked-item stock decrement, checksum-backed fiscal receipt handoff packets, full-sale refund evidence with tracked-line stock return moves, sale/refund revenue-VAT-settlement ledger journals, closed-session card terminal settlement evidence, and processor-fee reconciliation evidence shipped; offline replay, voids/partial refunds, receipt printing/live fiscal-device submission, payment split accounting, lots/serials/barcode depth, live terminal feeds, and chargeback reconciliation still missing | P1 |
...
- Cash full-sale refund evidence reduces open-session expected cash by the original paid-cash amount; card and bank-transfer refund evidence records the reversal without changing drawer cash. Tracked sale lines now restock through linked customer-to-internal return stock moves, sale/refund ledger journals post revenue, output VAT, and cash/bank/card-clearing settlement evidence, and closed card sessions can post terminal settlement evidence from card clearing to bank with optional processor-fee expense evidence. Fiscal refund submission, receipt printing, live terminal feeds, and chargeback handling remain deferred.
...
- Browser POS:
  ...
  - customer selection, discounts, returns/refunds. First full-sale refund evidence and tracked-line return stock moves shipped; customer-linked refunds, voids, and partial refunds remain.
  - barcode input.
...
5. POS with Armenian fiscal evidence; first cash-session closeout, cash sale posting, stock decrement, local receipt handoff packets, full-sale refund evidence, sale/refund ledger journals, closed-session card terminal settlement evidence, and processor-fee reconciliation evidence shipped, next focus is offline/live-fiscal-device handling, richer returns, live terminal feeds, and chargeback reconciliation.
