...
- A1 has projects, project template evidence, tasks, subtask hierarchy evidence, task dependency evidence, milestones, time entries, project billing, project-level profitability evidence, service cases, support replies, escalations, and Customer 360.
- Missing the reference ERP-style depth: recurring tasks, SLA configuration UI, field service planning, worksheets, dispatch/mobile technician flows, and profitability reporting below project level, including task/product cost basis.
