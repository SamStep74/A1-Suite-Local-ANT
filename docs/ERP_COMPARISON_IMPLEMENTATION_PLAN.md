...
- A1 now has a first POS cash-session, sale-posting, fiscal-handoff, accounting, terminal-settlement, and refund-evidence spine: POS app entry, role-gated workspace, tenant-scoped cash sessions, register opening, Z-report-like closeout evidence, receipt range fields, durable sale/line rows, cash expected-cash updates, source-key replay, stock delivery moves for stock-tracked fiscal items, checksum-backed local receipt handoff packets, sale/refund revenue-VAT-settlement ledger journals, closed-session card terminal settlement evidence, full-sale refund evidence with tracked-line stock return moves, audit events, and backup coverage.
- A1 still does not have full retail operations: offline replay, voids/partial refunds, receipt printing/live fiscal-device submission, payment split accounting, lots/serials, live payment-terminal provider feeds, processor-fee/chargeback reconciliation, loyalty, or deep barcode operations.
...
| POS | Browser POS, offline mode, cash sessions, stock sync, receipts | First cash-session/fiscal closeout spine, cash sale posting, tracked-item stock decrement, checksum-backed fiscal receipt handoff packets, full-sale refund evidence with tracked-line stock return moves, sale/refund revenue-VAT-settlement ledger journals, and closed-session card terminal settlement evidence shipped; offline replay, voids/partial refunds, receipt printing/live fiscal-device submission, payment split accounting, lots/serials/barcode depth, live terminal feeds, and fee/chargeback reconciliation still missing | P1 |
...
- Cash full-sale refund evidence reduces open-session expected cash by the original paid-cash amount; card and bank-transfer refund evidence records the reversal without changing drawer cash. Tracked sale lines now restock through linked customer-to-internal return stock moves, sale/refund ledger journals post revenue, output VAT, and cash/bank/card-clearing settlement evidence, and closed card sessions can post first terminal settlement evidence from card clearing to bank. Fiscal refund submission, receipt printing, live terminal feeds, processor-fee reconciliation, and chargeback handling remain deferred.
...
- Finance integration:
  - POS sale -> revenue/VAT/cash/bank/card-clearing journal. First balanced sale ledger posting and card terminal clearing-to-bank settlement shipped; payment split, live terminal feeds, processor fees, and chargebacks remain.
...
5. POS with Armenian fiscal evidence; first cash-session closeout, cash sale posting, stock decrement, local receipt handoff packets, full-sale refund evidence, sale/refund ledger journals, and closed-session card terminal settlement evidence shipped, next focus is offline/live-fiscal-device handling, richer returns, live terminal feeds, and fee/chargeback reconciliation.
