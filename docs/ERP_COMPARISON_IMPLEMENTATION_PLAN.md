...
- Browser POS:
  ...
  - local offline replay readiness queue evidence, first browser-local sale draft storage/manual retry, browser-offline sale capture drafts, durable local-draft replay evidence bridging/rejection closure, and safe automatic replay/conflict surfacing for network-failed/browser-offline sale drafts shipped; full fiscal/printer/terminal offline execution remains.
